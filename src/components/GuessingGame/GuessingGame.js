...
class GuessingGame extends Component {
  ...
  renderSubmission() {
    return (
      <React.Fragment>
        <Row className="justify-content-md-center float-right"><div className="switch-tab"><Button onClick={() => this.switchMode()}>View guessed words</Button></div></Row>
  ...
  renderGuessing() {
    return (
      <React.Fragment>
        <Row className="justify-content-md-center float-right"><div className="switch-tab"><Button onClick={() => this.switchMode()}>Submit new words</Button></div></Row>
        <Row className="justify-content-md-center mx-5">
